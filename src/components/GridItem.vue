    ...
    export default {
        ...
        mounted: function () {
            this.$nextTick(()=>{
                ...
                this.rowHeight = this.$parent.height;
                ...
                if (this.isFixarea === null) {
                    this.isFixarea = this.$parent.isFixarea;
                } else {
                    this.isFixarea = this.isFixarea;
                }
                    ...
                    case "dragend": {
                        ...
                        this.eventBus.$emit('judgeFixArea',(hasMove)=>{
                            if(hasMove){
                                ...
                                var pos= this.calcPosition(...this.oldPostion)
